<x-profile-preview :friendsPage="true" :user="$user" :request="$request">
    ...
    <div class="pt-6 grid grid-cols-1 gap-y-4">
        ...
        <x-glass-container>
            ...
            <div>
                ...
                <!-- if attachments is not empty, we are loading the carousel -->
                @if($post->attachments->isNotEmpty())
                <div id="gallery" class="relative w-full mt-3" data-carousel="slide">
                    <!-- Carousel wrapper -->
        ...
        @endforeach
        @else
        <p class="mt-10 text-center">No retweaks yet</p>
        @endif
    </div>
